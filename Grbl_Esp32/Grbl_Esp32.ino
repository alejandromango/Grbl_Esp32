...
void loop() {
    ...
    sys_position[DC_TOP_LEFT] = 225.7 * DC_TOP_LEFT_STEPS_PER_MM;
    sys_position[DC_TOP_RIGHT] = 225.7 * DC_TOP_RIGHT_STEPS_PER_MM;
    sys_position[DC_BOTTOM_LEFT] = 225.7 * DC_BOTTOM_LEFT_STEPS_PER_MM;
    sys_position[DC_BOTTOM_RIGHT] = 225.7 * DC_BOTTOM_RIGHT_STEPS_PER_MM;
